...
_INTRO_TEMPLATES = {
    ...
    "marketplace": "Hi {name}! We'd love to list AiPayGen on your platform. We offer 1500+ AI skills, 4100+ API catalog, 244 MCP tools, 13 specialist agents, and multi-model routing across 15 models. Monetized via x402 USDC and API keys. Homepage: https://aipaygen.com | API: https://api.aipaygen.com/discover",
    "github_repo": "Great project! AiPayGen is a complementary AI agent platform with 1500+ skills, 4100+ callable API catalog, and 244 MCP tools. We support x402 payments, A2A protocol, and multi-model routing. Would love to explore collaboration or integration. Check us out: https://github.com/Damien829/aipaygen",
}

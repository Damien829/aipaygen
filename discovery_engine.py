...
AWESOME_LIST_TARGETS = [
    ...
    (
        ...
        "Machine Learning",
        "| AiPayGen | Claude-powered AI API — research, write, code, analyze, 169 tools and 140+ endpoints. First 10 calls/day free. | No | Yes | Yes |",
    ),
    (
        "humanloop/awesome-ai-agents",
        "APIs",
        "- [AiPayGen](https://api.aipaygen.com) - Pay-per-use Claude AI API with 169 tools and 140+ endpoints. Agent messaging, task board, file storage, webhook relay. 10 free calls/day.",
    ),
    (
        "e2b-dev/awesome-ai-agents",
        "Tools",
        "- [AiPayGen](https://api.aipaygen.com) — Claude-powered pay-per-use API. 169 tools and 140+ endpoints: AI, scraping, real-time data, file storage, webhook relay. Free tier included.",
    ),
    (
    ...
    try:
        ...
        pr_resp = requests.post(
            ...
            json={
                ...
                "body": (
                    "## Add AiPayGen\n\n"
                    "AiPayGen is a pay-per-use Claude AI API with 169 tools and 140+ endpoints:\n\n"
...
This is for AiPayGen (https://api.aipaygen.com) — a pay-per-use Claude AI API with 169 tools and 140+ endpoints.

...
<meta name="description" content="155 AI tools, 15 frontier models, one API key. Research, write, code, scrape, analyze — from $0.004/call. No subscriptions.">
<style>
...
<div class="wrapper">
  ...
  <div class="card pkg-section active" id="tab-credits">
    ...
    <p class="sub">155 tools. 15 frontier models. Pay per call, not per month.</p>
  ...
  <div class="card pkg-section" id="tab-packages">
    ...
    <div class="pkgs">
      ...
      <div class="pkg selected" data-amount="25" data-label="full-access" onclick="selectPkg(this)">
        ...
        <div class="pkg-tools">All 155 tools &middot; 15 models &middot; scraping &middot; memory &middot; workflows &middot; agent network</div>
  ...
  <div class="trust">
    ...
    155 tools &middot; 15 frontier models &middot; 4100+ APIs &middot; Published on <strong>PyPI</strong> &amp; <strong>MCP Registry</strong><br>
  ...
  <div class="how">
    ...
    <span class="step">3.</span> Call any of 153 endpoints &mdash; credits deducted per call
  </div>
</div>
<script>

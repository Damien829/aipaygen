...
**169 AI tools for Claude, Cursor, Windsurf, and any MCP-compatible agent.**
...
## 169 tools Across 15 Categories
...
- **169 tools, one install** — no juggling API keys for 10 different services
